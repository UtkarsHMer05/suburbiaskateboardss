 ...
 * The Logo component:
 * --------------------------------
 * • A functional React component that renders the Suburbia Skate Logo as an SVG.
 * • It accepts all valid SVGProps<SVGSVGElement>, allowing you to pass additional
 *   attributes like className, style, and more when using this component.
 */
export function Logo(props: SVGProps<SVGSVGElement>) {
  return (
    <svg
      /* 
        xmlns sets the SVG namespace, required for valid SVG markup. 
        fill="none" means the default fill color is none for shapes unless specified otherwise.
        viewBox defines the coordinate system for the SVG.
        {...props} spreads any additional attributes passed to the component (e.g., className).
      */
    ...
    >
      {/* 
        <title> describes the graphic for accessibility (e.g., screen readers). 
        It's particularly useful if the SVG stands alone or is crucial to the page's meaning.
      */}
      <title>Suburbia Skate Logo</title>

      {/* 
        This <path> element:
        • fill="currentColor" means it uses the current text or parent color.
        • The 'd' attribute contains the drawing instructions for the logo outline.
        • It's an extensive path describing the detailed shape of the Suburbia Skate Logo.
      */}
      <path
        fill="currentColor"
